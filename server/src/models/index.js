...
db.tarotReadingInterpretations = require('./tarotReadingInterpretation.model.js')(sequelize, Sequelize);
...
// Tarot associations
db.users.hasMany(db.tarotReadings, { foreignKey: 'user_id' });
db.tarotReadings.belongsTo(db.users, { foreignKey: 'user_id' });
...
db.tarotReadings.hasMany(db.tarotReadingInterpretations, { foreignKey: 'reading_id' });
db.tarotReadingInterpretations.belongsTo(db.tarotReadings, { foreignKey: 'reading_id' });
